...
A ideia principal do projeto era fazer com uma calculadora que fize-se calculos no Back-end (feitos pelo NodeJs) e salva-se no banco de dados (MariaDb) o resultado da operação matematica  posteriormente sendo usado para o histórico de operações passadas no front.
